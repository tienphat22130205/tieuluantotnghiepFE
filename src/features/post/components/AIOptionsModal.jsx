      ...
      <AnimatePresence>
        {isOpen && (
          <Dialog.Portal forceMount>
            ...
            >
              <Motion.div
                className="fixed top-1/2 left-1/2 w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-xl z-[9999] overflow-hidden border border-slate-200"
