...
const CoverPhoto = ({ coverPhoto, isMyProfile }) => {
  ...
  return (
    <div className="relative h-40 sm:h-52 md:h-64 bg-primary-600 dark:bg-slate-800 overflow-hidden group">
      ...
      {isMyProfile && (
        <button className="absolute bottom-3 right-3 bg-white dark:bg-slate-900 px-2.5 py-2 sm:px-4 sm:py-2 rounded-xl shadow-md hover:bg-slate-50 dark:hover:bg-slate-800 transition flex items-center gap-1.5 cursor-pointer border border-slate-100 dark:border-slate-700 lg:opacity-0 lg:group-hover:opacity-100">
